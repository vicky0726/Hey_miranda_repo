...
class TermaCondition extends StatefulWidget {
  const TermaCondition({Key? key}) : super(key: key);

  @override
  State<TermaCondition> createState() => _TermaConditionState();
}

class _TermaConditionState extends State<TermaCondition> {
  @override
